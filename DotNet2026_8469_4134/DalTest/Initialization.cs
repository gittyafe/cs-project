...
public static class Initialization
{
    ...
    private static void createCustomers()
    {
        ...
        ci.Create(new Customer(3, "Yehudit", "Shaagat", "431221111"));
        ci.Create(new Customer(4, "Tovi", "Mesilat", "464575678"));
        ci.Create(new Customer(4, "Shulamit", "netivot", "78787878"));
        ci.Create(new Customer(5, "Shosh", "Mesilat", "57453243"));
        ci.Create(new Customer(6, "Tamar", "Petah Tikva", "235437548"));
        ci.Create(new Customer(7, "Bina", "Mesilat", "45636457"));
        ci.Create(new Customer(8, "Shosh", "Rashbi", "7456634"));
        ci.Create(new Customer(9, "Tsipora", "Meromei Sade", "6547568"));
        ci.Create(new Customer(10, "Shosh", "Mesilat", "42556578"));
        ...
        ci.Create(new Customer(15, "Shosh", "Avney", "534465768"));
    }
    private static void createSales()
    {
        ...
        si.Create(new Sale(1, 1, 12, 43.8, true, new DateTime(2015, 12, 31), new DateTime(2016, 12, 31)));
        si.Create(new Sale(2, 2, 12, 44, false, new DateTime(2015, 12, 31), new DateTime(2016, 12, 31)));
